...
function collectTopicSentences() {
    ...
    const readersNote = `<p><i>This block was automatically generated from
    ...
    mainArticleElem.insertAdjacentHTML(
        ...
        `<div class="comment-holder">
            <div class="comment">
                <button id="autogenerated-summary-controller" onclick="toggleSummaryDisplay(this);">
                    Expand Topic Sentences <i class="fas fa-chevron-down"></i>
                </button>
                <div id="autogenerated-summary" style="display: none;">
                    ${readersNote}
                    <hr />
                    ${topicSentencesHTML}
                </div>
