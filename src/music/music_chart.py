...
def dump_top_tracks(k=10):
    ...
    file_path = "/Users/dchege711/dchege711.github.io/notebooks/_autogenerated/top-10-tracks.html"
    today_str = date.today().strftime("%Y-%m-%d")
    os.rename(
...
if __name__ == "__main__":
    ...
    prvs_filepath = glob("../../notebooks/_autogenerated/*-top-10-tracks.html")[0]
    today_str = date.today().strftime("%Y-%m-%d")
